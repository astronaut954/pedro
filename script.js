...
// ====================================
gsap.to("#cloud1a", 
    {x: "-=50",	duration: 4, repeat: -1, yoyo: true, ease: "sine.inOut"});
gsap.to("#cloud2a",
    {x: "+=40",	duration: 6, repeat: -1, yoyo: true, ease: "sine.inOut"});
gsap.to("#cloud3a",
    {x: "-=60",	duration: 10, repeat: -1, yoyo: true, ease: "sine.inOut"});
gsap.to("#cloud4a", 
    {x: "+=55",	duration: 5, repeat: -1, yoyo: true, ease: "sine.inOut"});
gsap.to("#cloud1b", 
    {duration: 7, repeat: -1, opacity: 0, scale: 2.4, ease: "linear"});
gsap.to("#cloud2b", 
    {duration: 6, repeat: -1, opacity: 0, scale: 1.6, ease: "linear"});
